<div class="products__grid">
    ...
    <div class="product-card">
        ...
        <div class="product-card__image-container">
            <img src="@asset('images/products/product5.png')" alt="Автоматизированные системы управления" class="product-card__image">
        </div>
        <a href="#" class="product-card__circle-button">
            <span class="product-card__circle-icon">→</span>
        </a>
    ...
    <div class="product-card">
        ...
        <div class="product-card__image-container">
            <img src="@asset('images/products/product6.png')" alt="Установки дозирования химических реагентов" class="product-card__image">
        </div>
        <a href="#" class="product-card__circle-button">
            <span class="product-card__circle-icon">→</span>
        </a>
