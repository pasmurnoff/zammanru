<div class="products__grid">
    <a href="product/мобильные-скважинные-компрессорные/" class="product-card">
        ...
        <h3 class="product-card__title">Мобильные скважинные компрессорные установки (МСКУ)
        </h3>
        <div class="product-card__image-container">
            <img src="<?= App\asset_path('images/products/product1.png'); ?>" alt="Мобильные скважинные компрессорные установки" class="product-card__image">
        </div>
    ...
    <a href="/product/автоматизированные-системы-управлен/" class="product-card">
        ...
        <div class="product-card__image-container">
            <img src="<?= App\asset_path('images/products/product5.png'); ?>" alt="Автоматизированные системы управления" class="product-card__image">
        </div>
        <div class="product-card__circle-button">
            <span class="product-card__circle-icon">→</span>
        </div>
    ...
    <a href="/product/установки-дозирования-химических-ре/" class="product-card">
        ...
        <div class="product-card__image-container">
            <img src="<?= App\asset_path('images/products/product6.png'); ?>" alt="Установки дозирования химических реагентов" class="product-card__image">
        </div>
        <div class="product-card__circle-button">
            <span class="product-card__circle-icon">→</span>
        </div>
